...
public class Lab10Ast extends Applet
{
    ...
    public static void flagOfDivision (Graphics g)
    {
        Expo.setBackground(g,Expo.black);
        for (int d = 1; d <= numDots; d++)
        {
    ...
    public static void flagOfCharlie (Graphics g)
    {
        Expo.setBackground(g,Expo.black);
        for (int d = 1; d <= numDots; d++)
        {
    ...
    public static void flagOfGelderland (Graphics g)
    {
        ...
        showName(g,"Elst, Gelderland");
    }
    
    public static void flagOfPowiat (Graphics g)
    {
        Expo.setBackground(g,Expo.black);
        for (int d = 1; d <= numDots; d++)
        {
        ...
        showName(g,"Powiat Wodzislawski");
    }
}
